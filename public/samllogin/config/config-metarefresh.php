<?php
//var_dump($GLOBALS['samlIni']['FEDERATION_EXPIRE_AFTER']);
//die();
$config = [
    /*
    ...
    'sets' => [
        ...
        'kalmar' => [
            'cron' => [$GLOBALS['samlIni']['FEDERATION_CRON']],
            'sources' => [
                [
                    /*
                    ...
                    #'conditionalGET' => true,
                    'src' => $GLOBALS['samlIni']['FEDERATION_PATH'],
//                    'certificates' => [
//                        'current.crt',
//                        'rollover.crt',
//                    ],
            ...
            'expireAfter' => (int)$GLOBALS['samlIni']['FEDERATION_EXPIRE_AFTER'], // Maximum 4 days cache time (3600*24*4)
            'outputDir' => 'metadata/',
