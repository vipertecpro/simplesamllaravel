 ...
 *
 */
//var_dump((int)$GLOBALS['samlIni']['session.duration']);
//die();
$_SERVER['SERVER_PORT'] = $GLOBALS['samlIni']['SERVER_PORT'];
$_SERVER['HTTPS'] = $GLOBALS['samlIni']['HTTPS'];
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => $GLOBALS['samlIni']['BASE_PATH'],
     ...
     */
    'auth.adminpassword' => $GLOBALS['samlIni']['ADMIN_PASSWORD'],
     ...
     */
    'enable.http_post' => $GLOBALS['samlIni']['HTTP_POST'],
     ...
     */
    'debug' => array(
        'saml' => (boolean)$GLOBALS['samlIni']['debug.saml'],
        'backtraces' => (boolean)$GLOBALS['samlIni']['debug.backtraces'],
        'validatexml' => (boolean)$GLOBALS['samlIni']['debug.validatexml'],
    ),
     ...
     */
    'showerrors' => (boolean)$GLOBALS['samlIni']['show.error'],
    'errorreporting' => (boolean)$GLOBALS['samlIni']['show.error.reporting'],
     ...
     */
    'enable.saml20-idp' => (boolean)$GLOBALS['samlIni']['enable.saml20-idp'],
    'enable.shib13-idp' => (boolean)$GLOBALS['samlIni']['enable.shib13-idp'],
    'enable.adfs-idp' => (boolean)$GLOBALS['samlIni']['enable.adfs-idp'],
    'enable.wsfed-sp' => (boolean)$GLOBALS['samlIni']['enable.wsfed-sp'],
    'enable.authmemcookie' => (boolean)$GLOBALS['samlIni']['enable.authmemcookie'],
     ...
     */
    'session.duration' => (int)$GLOBALS['samlIni']['session.duration'], // 8 hours.
     ...
     */
    'session.datastore.timeout' => (int)$GLOBALS['samlIni']['session.datastore.timeout'] , // 4 hours

    /*
     * Sets the duration, in seconds, auth state should be stored.
     */
    'session.state.timeout' => (int)$GLOBALS['samlIni']['session.state.timeout'], // 1 hour

    /*
     * Option to override the default settings for the session cookie name
     */
    'session.cookie.name' => $GLOBALS['samlIni']['session.cookie.name'],
     ...
     */
    'session.cookie.lifetime' => (int)$GLOBALS['samlIni']['session.cookie.lifetime'],
     ...
     */
    'session.phpsession.cookiename' => $GLOBALS['samlIni']['session.phpsession.cookiename'],
     ...
     */
    'session.authtoken.cookiename' => $GLOBALS['samlIni']['session.authtoken.cookiename'],
    ...
    'session.rememberme.lifetime' =>  1209600 , //(14 * 86400),
    ...
    'language.cookie.lifetime' => 77760000, // 60 * 60 * 24 * 900
